    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
        {[
          ...
          { href: '/admin/cadastros', icon: 'M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2v-4M9 21H5a2 2 0 01-2-2v-4m0 0h18', label: 'Cadastros', desc: 'Contratos, funções e equipamentos' },
        ].map(item => (
